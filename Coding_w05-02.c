#include <stdio.h>
int main() {
    char name[30]; //ใช้ char array เพื่อเก็บชื่อของเรา ตัวอักษรหลายตัว
    int age; //ใช้ int เพื่อเก็บอายุเราเป็น เลขจำนวนเต็ม
    float height; //ใช้ float เพื่อเก็บส่วนสูง หน่วยเป็นเซนติเมตร
    char subject[30]; //ใช้ char array เพื่อเก็บชื่อวิชานั้นๆ ตัวอักษรหลายตัว
    float grade; //ใช้ float เพื่อเก็บเกรดในรูป เลขทศนิยม
    char gradechar; //ใช้ char เพื่อเก็บเกรดในรูปแบบตัวอักษร

    printf ("Enter your name , age ,height, subject, grade: "); //ขอข้อมูลชื่อ, อายุ, ส่วนสูง, วิชา, เกรดจากผู้ใช้
